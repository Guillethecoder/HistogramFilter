...
vector < vector <float> > blur(vector < vector < float> > grid, float blurring) {
	...
	float cen = 1.0 - blurring, cor = blurring / 12.0, adj = blurring / 6.0;

	vector <vector <float> > window = { {cor, adj, cor},
									   {adj, cen, adj},
									   {cor, adj, cor} };
